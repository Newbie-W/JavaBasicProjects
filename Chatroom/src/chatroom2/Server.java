...
public class Server {  
    ...
    public void send() {  
        ...
        for (int i=0;i<clients.size();i++){
        	System.out.println("server:"+clients.get(i).getWriter()+"&&"+clients.get(i).reader);
        	if (clients.get(i).getWriter().equals(clients.get(i).reader))System.out.println("serverok!");
        }
    ...
    public Server() {  
        ...
        leftPanel = new JScrollPane(userList);  //滑动条面板
    ...
    class ClientThread extends Thread {  
        ...
        public void dispatcherMessage(String message) {  
            ...
            //System.out.println("server"+string+" ## "+owner);
            if (owner.equals("ALL")) {// 群发  
            	...
            	for (int i=0;i<clients.size();i++){
            		...
            		if (owner.equals(clients.get(i).user.getName())){//发给私聊信息接收者
            			//System.out.println("server 转发："+message);
            			
            			message = source + "悄悄对你【"+owner+"】说：" + content;
            			contentArea.append(message + "\r\n");
            			clients.get(i).getWriter().println(message + "(私发)");  
                        clients.get(i).getWriter().flush();  
            		}
            		if (source.equals(clients.get(i).user.getName())){//发送给私聊信息发送者
            			message = "你【"+source+"】悄悄对"+owner+"说："+content;
            			contentArea.append(message + "\r\n");
            			clients.get(i).getWriter().println(message + "(私发)");  
                        clients.get(i).getWriter().flush(); 
            		}
